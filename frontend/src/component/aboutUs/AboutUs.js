        ...
        <div className="main__about wrapper">
            <div className="main__about container">
                ...
                <p className="about__text">
                    ...
                    специалистами в области информационных технологий с 35 летним стажем,
                    осуществляет разработку и эксплуатацию информационных систем и 
                    ресурсов, обеспечивающих повышение эффективности работы крупных 
